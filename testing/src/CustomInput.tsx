...
function CustomInput2<T extends object>(
    props: { form: FormState<T>; name: keyof T } & Omit<InputHTMLAttributes<HTMLInputElement>, "form" | "name">
) {
...
function CustomInput5<T extends object, Key extends keyof T>(
