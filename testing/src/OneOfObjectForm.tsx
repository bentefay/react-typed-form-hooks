...
import { AnyListener, Field, FormState, Listener, useObjectField, useForm } from "react-typed-form-hooks";
...
export default function OneOfObjectArrayForm() {
    ...
    return (
        <form
            ...
            <a href="https://github.com/CodeStix/typed-react-form/blob/master/example/src/OneOfObjectForm.tsx">
                View source code
            </a>
